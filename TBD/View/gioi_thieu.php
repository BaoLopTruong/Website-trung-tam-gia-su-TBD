							...
							<div class="container clearfix">
								...
								<ul>
									...
									<li><span style="font-size:18px;">
											<p> cho học sinh đăng ký full khóa học và đóng học phí trong ngày nhập học.<span style="background-color:#ffffff;"></span></p>
										</span></li>
									<li><span style="font-size:18px;">
											<p> Đăng ký theo nhóm từ 3 học sinh trở lên.</p>
										</span></li>
									<li><span style="font-size:18px;">
											<p> 100% học sinh nhập học và đóng học phí trong ngày nhập học sẽ có quà tặng cực HOT </p>
										</span></li>
								</ul>
								...
								<ul>
									<li><span style="font-size:18px;">
											<p>Kiểm tra đầu vào để phân loại học sinh và chuẩn bị giáo trình phù hợp.</p>
										</span></li>
									<li><span style="font-size:18px;">
											<p>Ôn tập lại toàn bộ những kiến thức đã học ở trường,cho ví dụ cụ thể .<span style="background-color:#ffffff;"></span></p>
										</span></li>
									<li><span style="font-size:18px;">
											<p>Với những em có học lực khá giỏi chúng tôi sẽ nâng cao kiến thức để các em có thể phát huy hết khả năng của mình.</p>
										</span></li>
									<li><span style="font-size:18px;">
											<p>Nội dung bài giảng được biên soạn bởi chuyên gia của trung tâm có nhiều năm kinh nghiệm giảng dạy.</p>
										</span></li>
									<li><span style="font-size:18px;">
											<p>Luôn hướng học sinh phải thực hành nhiều bằng những bài tập cơ bản và nâng cao.</p>
										</span></li>
									<li><span style="font-size:18px;">
											<p>Thường xuyên cập nhật kết quả cho quý phụ huynh ít nhất một tuần một lần</p>
										</span></li>
								</ul>
								...
								<ul>
									<li><span style="font-size:18px;">
											<p>Hiệu quả uy tín là tiêu chí hàng đầu của trung tâm gia sư tuổi trẻ</p>
										</span></li>
									<li><span style="font-size:18px;">
											<p>Cung cấp những gia sư có trình độ chuyên môn cao.</p>
										</span></li>
									<li><span style="font-size:18px;">
											<p>Hủy hợp đồng đối với những gia sư thiếu trách nhiệm.</p>
										</span></li>
									<li><span style="font-size:18px;">
											<p>Gia sư chúng tôi được đào tạo bài bản trước khi nhận lớp.</p>
										</span></li>
									<li><span style="font-size:18px;">
											<p>Cam kết học sinh sẽ tiến bộ sau nữa tháng học.</p>
										</span></li>
									<li><span style="font-size:18px;">
											<p>Phụ huynh chỉ đóng học phí sau khi hài lòng về cách dạy của các gia sư.</p>
										</span></li>
								</ul>
